...
import { AiSkillsGapPanel } from "@/components/ai/AiSkillsGapPanel";
import { AiGlobalTrends } from "@/components/ai/AiGlobalTrends";
import { AiRiskMitigationFlow } from "@/components/ai/AiRiskMitigationFlow";

type TabId = "skills-gap" | "risk" | "trends";

const TABS: { id: TabId; label: string }[] = [
  { id: "skills-gap", label: "The AI-era skills gap" },
  { id: "risk", label: "Mitigating AI and model risk" },
  { id: "trends", label: "Global AI adoption trends" },
];

export function AiTrainingProgramTabs() {
    ...
    <>
      ...
      >
        <div className="eds-page-center">
          <div
            role="tablist"
            aria-label="Corporate AI training program views"
      ...
      >
        {active === "skills-gap" && <AiSkillsGapPanel />}
        {active === "risk" && <AiRiskMitigationFlow />}
        {active === "trends" && <AiGlobalTrends />}
      </div>
