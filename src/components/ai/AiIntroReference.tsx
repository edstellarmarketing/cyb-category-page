...
const leftItems = [
  {
    ...
    text: "Every engagement starts with a capability roadmap aligned to your AI goals.",
    icon: Target,
  },
  {
  ...
  },
  {
    ...
    text: "GPU sandboxes, notebooks, RAG and agent labs power real-world practice.",
    icon: Cloud,
  },
  {
    title: "Measurable ROI",
    text: "Pre/post skill assessments, training outcomes and model performance KPIs tracked and reported.",
    icon: BarChart3,
  },
];
...
const cards = [
  {
    ...
    quote: "Keeping engineers current on GenAI, LLMs & emerging AI tech?",
  },
  {
  ...
  },
  {
    ...
    quote: "Measure proficiency gains & AI ROI?",
  },
];

const proofItems = [
  {
    title: "Industry-practitioner trainers",
  ...
  {
    title: "Actionable reports for L&D leaders and CTOs",
    text: "Transparent reporting for L&D leaders and CTOs",
    icon: FileText,
  },
  {
...
export function AiIntroReference() {
  return (
    <section
      aria-labelledby="ai-intro-reference-title"
        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_1fr] lg:min-h-[680px]">
          <div>
            ...
            <p
              ...
              style={{ fontFamily: FONT_LIGHT }}
            >
              Edstellar designs AI capability around your stack, your data and your governance
              obligations. Every customized, instructor-led program turns a training engagement into
              measurable outcomes your CTO and board can rely on.
            </p>
            ...
            <div className="absolute left-[258px] top-[204px] z-20 flex h-[276px] w-[276px] items-center justify-center rounded-full border-[7px] border-[#6366F1] bg-white text-center shadow-[0_15px_38px_rgba(44,47,145,0.15)]">
              ...
              <div>
                ...
                <p className="mx-auto mt-5 max-w-[150px] text-[14px] italic leading-[1.45] text-[#697084]" style={{ fontFamily: FONT_REGULAR }}>
                  &ldquo;Vision for our organization&apos;s AI capability growth?&rdquo;
                </p>
              </div>
            </div>
