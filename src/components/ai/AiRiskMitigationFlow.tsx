...
const STEPS: FlowStep[] = [
  {
    num: "01",
    title: "Govern",
    body: "Teams trained on the EU AI Act, NIST AI RMF and ISO/IEC 42001 classify models, document controls and produce audit evidence. Instructor-led group training closes governance gaps before a regulator or board ever asks.",
    metric: "ISO 42001",
    metricCaption: "AI governance baseline",
  },
  {
    num: "02",
    title: "Validate",
    body: "Instructor-led hands-on labs teach engineers to test for model failures: drift, bias, prompt injection and ungrounded output. Evaluation and red-teaming become routine, so models reach production proven, not assumed.",
    metric: "RAG + eval",
    metricCaption: "grounding and testing",
  },
  {
    num: "03",
    title: "Enable",
    body: "Shadow AI grows when employees lack a safe, sanctioned path. Broad instructor-led enablement on approved tools, prompts and data handling replaces unmanaged usage with governed adoption across every function.",
    metric: "Every role",
    metricCaption: "governed AI adoption",
  },
];
...
export function AiRiskMitigationFlow() {
  return (
    <section
    ...
    >
      ...
      <div className="eds-page-center">
        <div className="max-w-3xl">
          ...
          >
            Ungoverned AI Is Now an Enterprise Risk, Not Just a Missed{" "}
          ...
          >
            ...
            AI deployment. Trained teams close governance gaps, catch model
            failures before production, and replace shadow AI with governed
            adoption, so the same model carries measurably less risk.
          </p>
        </div>
        ...
        >
          Frameworks referenced: EU AI Act, NIST AI Risk Management Framework,
          ISO/IEC 42001. Risk outcomes vary by sector, model footprint and
          governance maturity.
        </p>
      </div>
    </section>
