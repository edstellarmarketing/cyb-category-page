...
const stats = [
  {
    ...
    text: "Program design, not catalog selection. Built around your stack, data and governance obligations.",
    icon: ClipboardCheck,
  },
  {
    value: "100+",
  ...
  },
  {
    ...
    text: "Caliber you can trust. Interview and run a trial session with your shortlisted trainer before you commit.",
    icon: UsersRound,
  },
];
...
const capabilities = [
  {
    ...
    text: "Customized AI training designed around your stack, data and roles, not pulled from a generic catalog.",
    icon: ClipboardCheck,
  },
  {
    title: "On-site or virtual, wherever you operate",
    text: "A vetted instructor, in your office or online, aligned to your governance obligations. We deliver in-region, in-language.",
    icon: GraduationCap,
  },
  {
  ...
  },
  {
    ...
    text: "Flexible AI training packages aligned to your goals, team structure, skill gaps, and enterprise learning requirements.",
    icon: UsersRound,
  },
  {
...
export function AiWhyEdstellar() {
  return (
    <section
        ...
        <div className="grid gap-6 lg:grid-cols-[1.35fr_0.65fr]">
            <div>
              ...
              >
                ...
                <span className="text-[#6366F1]">Build AI Capability</span>
              </h2>
              <p
                className="mt-5 max-w-4xl text-[16px] leading-[1.6] text-[#374151] sm:text-[17px]"
                style={{ fontFamily: FONT_LIGHT }}
              >
                Edstellar is an AI corporate training company built for enterprise workforce development.
                We design every skilling, upskilling and reskilling program around your stack and
                governance, delivered through instructor-led group training led by industry practitioners.
                As an AI training provider in 100+ countries, engagements tie to outcomes your board can
                act on.
              </p>
              <blockquote
              ...
              >
                ...
                trainer, and delivers a post-program report your CTO can take to the board: skills delta,
                model accuracy gains and time-to-deployment.
              </blockquote>
            </div>
            ...
            <div className="relative min-h-[260px] overflow-hidden rounded-[18px] bg-[#071735] lg:min-h-0">
              <Image
                ...
                alt="Instructor-led AI training session for enterprise teams"
                fill
          ...
          <div className="mt-5 grid gap-5 rounded-[14px] bg-[#073A93] px-6 py-6 text-white md:grid-cols-[1fr_1.15fr_1.2fr] md:items-center">
            ...
            <div className="relative min-h-[150px]">
              <Image
                ...
                alt="Countries where Edstellar has delivered AI training"
                fill
