...
const STEPS: Step[] = [
  {
    ...
    title: "Discover",
    description:
      "We meet with your CTO and L&D team to map current AI capabilities against role-based benchmarks. Output: a prioritised skill-gap report with ROI-aligned objectives.",
  },
  {
    num: "02",
    title: "Design",
    description:
      "We build a custom curriculum mapped to NIST AI RMF and ISO/IEC 42001 roles, then shortlist certified trainers from our 1,500+ network for trial sessions on your real stack.",
  },
  {
    num: "03",
    title: "Deliver",
    description:
      "Instructor-led sessions, virtual, on-site or hybrid, in your language, with hands-on GPU sandboxes, notebooks, RAG pipelines and agent environments shipped with every cohort.",
  },
  {
    num: "04",
    title: "Assess",
    description:
      "Pre and post technical assessments, skill mastery tracking, lab benchmarks and model performance KPIs. Every cohort closes with a measurable skills delta.",
  },
  {
    num: "05",
    title: "Optimise",
    description:
      "Quarterly retrospectives, refresher modules, skill-refresh tracking and a dedicated Learning Services Manager driving long-term AI ROI.",
  },
];

export function AiOurApproach() {
  return (
      ...
      <div className="eds-page-center">
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div className="max-w-3xl">
            ...
            >
              Edstellar Approach to Organizational AI Training
            </h2>
            <p
            ...
            >
              ...
              methodology that turns AI training into measurable capability inside
              your organisation.
            </p>
          </div>
          <a
