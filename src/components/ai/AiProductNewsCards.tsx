...
const PROGRAMS: Program[] = [
  {
    ...
    description:
      "Build production generative AI systems with large language models, RAG pipelines, evaluation and agent workflows on your own stack.",
  ...
  },
  {
    ...
    delivery: "Instructor-led (On-site/Virtual)",
    description:
      "Develop, train and evaluate supervised and unsupervised models with scikit-learn, pandas and NumPy across real enterprise datasets.",
  ...
  },
  {
    ...
    delivery: "Instructor-led (On-site/Virtual)",
    description:
      "Design reliable prompts, system instructions and structured outputs for ChatGPT and Copilot, with patterns for grounding and safe daily use.",
  ...
  },
  {
    ...
    delivery: "Instructor-led (On-site/Virtual)",
    description:
      "Apply the EU AI Act, NIST AI RMF and ISO/IEC 42001 to classify model risk, build audit evidence and deploy AI responsibly across the enterprise.",
...
export function AiProductNewsCards() {
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h2
              ...
              style={{ fontFamily: "'Riona Sans Light', Helvetica, Arial, sans-serif" }}
            >
              Industry-Aligned AI Training Programs Your Teams Can Trust
            </h2>
            <p
              className="mt-4 max-w-3xl text-[17px] leading-[1.35] text-white/75 sm:text-[19px]"
              style={{ fontFamily: "'Riona Sans Light', Helvetica, Arial, sans-serif" }}
            >
              A curated selection from Edstellar&apos;s 120+ instructor-led AI group training programs for enterprise employees, delivered live, on-site or virtual, with measurable outcomes.
            </p>
          </div>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-5 rounded-2xl border border-eds-gray-200 bg-[#F5F3FF] px-8 py-6 sm:flex-row">
          <div>
            <h3
              ...
              style={{ fontFamily: "'Riona Sans Regular', Helvetica, Arial, sans-serif" }}
            >
              Explore the Complete Edstellar AI Training Catalog
            </h3>
            <p
              className="mt-1 text-[15px] text-eds-gray-500"
              style={{ fontFamily: "'Riona Sans Light', Helvetica, Arial, sans-serif" }}
            >
              Browse 120+ AI training programs or request the latest catalog delivered to your inbox.
            </p>
          </div>
