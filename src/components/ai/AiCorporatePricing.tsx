...
const DELIVERY_OPTIONS = [
  {
    ...
    description:
      "Our virtual group training sessions bring expert-led, high-quality AI training to your teams anywhere, ensuring consistency and seamless integration into their schedules.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Edstellar deploys a vetted trainer to your office for immersive, hands-on AI learning experiences. Available for any group size, anywhere.",
    benefits: [
      ...
      "Direct trainer Q&A and hands-on demonstration of real AI scenarios",
    ],
  },
];
...
const SHARED_BENEFITS: { label: string; description: string }[] = [
  {
    label: "120+ AI Training Programs",
    description:
      "Generative AI and LLMs, machine learning, computer vision, NLP, AI governance and more, across every enterprise AI domain.",
  },
  {
    label: "1,500+ Vetted AI Trainers",
    description:
      "Practitioner-led delivery matched to your model stack, tools, language and timezone across 100+ countries.",
  },
  {
    label: "Hands-on GPU labs included",
    description:
      "GPU sandboxes, Jupyter and Colab notebooks, RAG pipelines and agent labs included with every cohort.",
  },
  {
    label: "On-site, virtual or hybrid delivery",
    description:
      "Live instructor-led training for AI teams, co-located, distributed or fully remote, in any timezone.",
  },
  {
    label: "Pre and post skill assessments",
    description:
      "Role-based competency baselining before training and skill mastery measurement after, with reporting your CTO can present to the board.",
  },
  {
    label: "Trainer-fit trial sessions",
    description:
      "Validate domain depth against your actual model stack before committing the cohort, trial sessions with your shortlisted trainer.",
  },
];
...
export function AiCorporatePricing() {
  return (
    <section className="bg-[#F5F3FF] py-16 md:py-20">
      <div className="eds-page-center">
        <h2
          ...
          style={{ fontFamily: "'Riona Sans Light', Helvetica, Arial, sans-serif" }}
        >
          Artificial Intelligence Group Training Packages &amp; Pricing
        </h2>
        <p
          className="mt-4 max-w-3xl text-[17px] leading-[1.35] sm:text-[18px]"
          style={{ fontFamily: "'Riona Sans Light', Helvetica, Arial, sans-serif" }}
        >
          Our AI group training is tailored to your specific upskilling needs. Explore transparent pricing options that fit your training budget, whether you&apos;re training a small group or a large team across the enterprise.
        </p>
