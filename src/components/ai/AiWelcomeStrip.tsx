...
const QUADRANTS: FrameworkCard[] = [
  {
    ...
    bullets: ["GenAI, LLMs & agentic AI", "MLOps & responsible AI"],
    question: "Keep engineers current on GenAI, LLMs & emerging AI tech?",
  },
  {
    num: "2",
    title: "Customized Instructor-led Training",
    bullets: ["Role-based paths (ML, Data, Product)", "Customized programs per role"],
    question: "Which training programs fit our stack & teams?",
  },
  {
    num: "3",
    title: "Hands-on Labs",
    bullets: ["GPU sandboxes & notebooks", "RAG, fine-tuning & agent labs"],
    question: "Where can engineers practice real workloads safely?",
  },
  {
    num: "4",
    title: "Assessment & ROI",
    bullets: ["Pre/post skill assessments", "Model accuracy & deployment KPIs"],
    question: "Measure proficiency gains & AI ROI?",
  },
];
...
export function AiWelcomeStrip() {
  return (
    <section
      className="border-y"
    ...
    >
        ...
        <nav aria-label="Breadcrumb" className="eds-page-center py-3">
          ...
          >
            ...
            <li
              ...
              style={{ color: "#1B1D52" }}
            >
              <span itemProp="name">AI Training Programs</span>
      ...
      <div className="text-left">
        ...
        >
          Customized Artificial Intelligence Training Programs for Enterprise
        </h1>
      </div>
      ...
      <div className="mt-6 grid items-start gap-10 lg:grid-cols-12 lg:gap-14">
        <div className="text-left lg:col-span-5">
          ...
          >
            Edstellar is the AI training company enterprises rely on to build
            capability across generative AI, machine learning and AI governance.
            Whether teams need entry-level skilling, role-specific upskilling or
            senior reskilling, every group training cohort is matched to vetted,
            certified trainers.
          </p>
          <p
          ...
          >
            ...
            from new-hire cohorts to teams reskilling across AI domains.
          ...
          <ul className="space-y-3">
            ...
            <CheckBullet>
              ...
              GPU sandboxes, notebooks and RAG and agent labs power real-world
              practice.
            </CheckBullet>
            <CheckBullet>
              <strong style={{ color: "#1B1D52" }}>Measurable ROI.</strong>{" "}
              Pre/post skill assessments, training outcomes and model
              performance KPIs.
            </CheckBullet>
          </ul>
        </div>
        ...
        <div className="lg:col-span-7">
          ...
          >
            ...
            >
              ...
              >
                &ldquo;Vision for our organisation&apos;s AI capability growth?&rdquo;
              </div>
            </div>
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <h3
            ...
            style={{ color: "#1B1D52", fontFamily: "'Riona Sans Regular', Helvetica, Arial, sans-serif" }}
          >
            Instructor-led AI training that compounds business value.
          </h3>
          <p
            className="mx-auto mt-4 max-w-2xl text-[15px] leading-[1.5] sm:text-[16px]"
            style={{ color: "#374151", fontFamily: "'Riona Sans Light', Helvetica, Arial, sans-serif" }}
          >
            Edstellar&apos;s instructor-led AI group training spans 120+
            programs across 11 AI domains, designed for measurable workforce
          ...
          {[
            {
              stat: "78%",
              caption:
                "Of organizations now use AI in at least one business function, intensifying demand for trained teams.",
              source: "McKinsey State of AI 2024",
            },
            {
              stat: "$4.4T",
              caption:
                "Estimated annual value generative AI could add to the global economy across enterprise use cases.",
              source: "McKinsey 2023",
            },
            {
              stat: "39%",
              caption:
                "Of workers' core skills are expected to change by 2030, driven by AI and automation.",
