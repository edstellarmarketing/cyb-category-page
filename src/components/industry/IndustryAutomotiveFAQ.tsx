...
const FAQS: FAQ[] = [
  ...
  },
  {
    ...
    a: "We start with a workforce skill-mapping exercise against future-state automotive roles, then design a role-based learning path blended with hands-on labs against your stack (AUTOSAR, ROS, MATLAB / Simulink, vCAN tools, MES / SCADA platforms). Learning paths are mentor-led, vendor-certified, and packaged with pre and post assessments so the impact is measurable.",
  },
  {
    q: "Can you deliver training on-site at our plants and engineering centres?",
    a: "Yes. Edstellar supports on-site delivery at plants, design centres, R&D labs, and innovation hubs, plus virtual and blended formats for distributed teams. A single Edstellar project manager coordinates schedules, languages, venues, lab environments, and certification logistics across regions and shifts.",
  },
  {
  ...
  },
  {
    ...
    a: "Edstellar delivers in 10 languages, including English, Español, 普通話, Deutsch, العربية, Português, हिंदी, Français, 日本語, and Italiano, across 100+ countries. Multi-region cohorts run in matched time zones so global automotive teams progress in parallel rather than waiting on each other.",
  },
  {
