...
const TABS: Tab[] = [
  {
    ...
    context:
      "Build deep, role-specific capability across automotive product, manufacturing, and aftermarket teams with vendor-certified instructors, hands-on labs, and 1:1 coaching tuned to your stack.",
    ...
    bullets: [
      {
        ...
        body: "End-to-end ownership of training delivery, scheduling, logistics, attendance, certification tracking, and reporting across multiple geographies and shifts.",
      },
      {
        title: "Training Vendor Sourcing and Management.",
        body: "Curate, contract, and govern external vendors for niche automotive needs (OEM-specific tooling, regulatory updates, supplier-mandated certifications) under one master agreement.",
      },
    ],
  },
  {
