...
const SLIDES: HeroSlide[] = [
  {
    ...
    description:
      "Edstellar is the corporate cybersecurity training partner of choice for CISOs and security leaders racing to upskill employees on offensive security, cloud security, GRC and AI-era threats. Our instructor-led cybersecurity training spans 200+ programs across 8 cyber domains, delivered virtually, on-site or off-site by vendor-certified trainers, so every cohort closes the cyber skills gap and turns learning into measurable security outcomes.",
    primaryCta: "Browse Cybersecurity Courses",
  ...
  },
  {
    ...
    description:
      "Hospitals, payers, pharma and medtech firms partner with Edstellar for instructor-led cybersecurity training on HIPAA, HITRUST, medical-device security and ransomware response. Corporate cybersecurity training programs for healthcare employees, delivered virtually or on-site, prepare clinical-IT and security teams for the next decade of regulated digital care.",
    primaryCta: "Explore Healthcare Cybersecurity",
    secondaryCta: "Talk to an Expert",
  ...
  },
  {
    ...
    description:
      "SaaS, fintech and AI-first enterprises deploy Edstellar's instructor-led cybersecurity training to upskill employees on LLM red-teaming, prompt-injection defence, MLOps security and AI governance. Corporate cybersecurity training programs built for security teams entering the GenAI era, with hands-on labs and vendor-certified instructors.",
    primaryCta: "Explore AI Security",
    secondaryCta: "Talk to an Expert",
