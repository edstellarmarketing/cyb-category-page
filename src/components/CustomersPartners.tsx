      ...
      <div className="eds-page-center">
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-20">
          <div>
            ...
            >
              Most providers sell you a seat in a course. Edstellar designs enterprise cybersecurity workforce development programs aligned to your threat landscape, validates industry-practitioner trainers, and delivers measurable post-training outcomes your CISO and L&amp;D leaders can report on, including skills improvement, MTTD reduction, incident response readiness, and vulnerability remediation progress.
            </blockquote>
          </div>
