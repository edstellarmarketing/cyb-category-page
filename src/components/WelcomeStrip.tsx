...
const QUADRANTS: FrameworkCard[] = [
  ...
  },
  {
    ...
    bullets: ["Role-based paths (SOC, Pentest, GRC)", "CISSP, CEH, CCSP, OSCP tracks"],
    question: "Which paths fit our stack & teams?",
  },
  {
    num: "3",
    title: "Hands-on Labs",
  ...
  },
  {
    ...
    bullets: ["Pre/post skill assessments", "MTTD, MTTR & cert pass-rates"],
        ...
        <nav aria-label="Breadcrumb" className="mtk-page-center py-3">
          ...
          >
            ...
            <li
              ...
              style={{ color: "#1B1D52" }}
            >
              <span itemProp="name">Cybersecurity Training Courses</span>
      ...
      <div className="mt-6 grid items-start gap-10 lg:grid-cols-12 lg:gap-14">
        <div className="text-left lg:col-span-5">
          ...
          >
            ...
            AI-security disciplines. Whether your team needs an entry-level
            SOC analyst track or a CISO-grade leadership program, every cohort
            is matched to vetted, vendor-certified trainers with hands-on
            enterprise practice.
          </p>
          <p
            ...
            style={{ color: "#374151", fontFamily: "'Riona Sans Light', Helvetica, Arial, sans-serif" }}
          >
            Every program is delivered onsite, off-site or virtually, in any
            language, and runs on our five-part transformation framework that
            turns learning into measurable security outcomes. Strategy,
            curriculum, hands-on labs, assessment and continuous mastery,
            engineered around your stack, your regulatory landscape and the
            security KPIs your board reports on.
          </p>
          <ul className="space-y-3">
            ...
            <CheckBullet>
              ...
              Pre/post skill assessments, certification pass-rates and security
              KPIs.
            </CheckBullet>
          </ul>
        </div>
