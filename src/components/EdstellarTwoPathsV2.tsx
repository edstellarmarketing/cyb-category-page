...
const HELPS = [
  ...
  },
  {
    ...
    body: "certified mentors and 1:1 coaching for senior analysts, with practitioners who have shipped in production.",
  },
  {
    title: "Measurable progress and skill validation",
    body: "Pre and post assessments, training milestones, and leadership-ready scorecards on every cohort.",
  },
];
...
const ADVANTAGES: Advantage[] = [
  ...
  },
  {
    ...
    body: "Mentor-led delivery and structured learning that retains talent and grows careers.",
  },
  {
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center gap-2">
        ...
        >
          {variant === "reactive"
            ? "Current SOC analyst journey in most organizations Â· reactive and fragmented"
        ...
        {variant === "optimized" && (
          <>
            ...
            >
              Â· structured Â· proactive Â· business-aligned
            </span>
          </>
        )}
      </div>
    ...
    <section className="bg-white py-16 md:py-20">
      <div className="mtk-page-center">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            Reactive SOC or proactive defense: which operating model is your business funding today?
          </h2>
          <p
