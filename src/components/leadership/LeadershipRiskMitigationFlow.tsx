...
const STEPS: FlowStep[] = [
  {
    num: "01",
    title: "Engage",
    body: "Gallup finds managers drive roughly 70% of the variance in team engagement, so a weak manager quietly erodes the whole team. Instructor-led group training on feedback, coaching and one-to-ones rebuilds the daily habits that keep people engaged and present.",
    metric: "70% variance",
    metricCaption: "manager drives engagement",
  },
  {
    num: "02",
    title: "Retain",
    body: "Disengaged teams and accidental managers are a direct line to regretted attrition. Structured, instructor-led development on delegation, difficult conversations and the first 90 days in role turns shaky promotions into managers people choose to stay for.",
    metric: "#1 L&D focus",
    metricCaption: "leadership development",
  },
  {
    num: "03",
    title: "Sustain",
    body: "Failed change initiatives and manager burnout follow when leaders are sent into restructures and mergers unprepared. Broad instructor-led enablement on leading through change and resilience replaces firefighting with leaders who can carry teams through it.",
    metric: "Every tier",
    metricCaption: "leaders ready for change",
  },
];
...
export function LeadershipRiskMitigationFlow() {
  return (
    <section
    ...
    >
      ...
      <div className="eds-page-center">
        <div className="max-w-3xl">
          ...
          >
            Weak Management Is an Attrition and Engagement Risk, Not Just a Soft{" "}
          ...
          >
            ...
            promotion. Trained managers lift engagement, reduce regretted
            attrition, steady teams through change and protect against burnout,
            so the same leader carries measurably less risk for the business.
          </p>
        </div>
        ...
        >
          Sources referenced: Gallup State of the Global Workplace 2024,
          LinkedIn Workplace Learning Report 2024. Risk outcomes vary by sector,
          manager tier and development maturity.
        </p>
      </div>
    </section>
  );
