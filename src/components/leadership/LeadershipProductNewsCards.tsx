...
const PROGRAMS: Program[] = [
  {
    ...
    description:
      "Strategic thinking, executive influence and enterprise decision-making for senior leaders and the C-suite.",
...
export function LeadershipProductNewsCards() {
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h2
              ...
              style={{ fontFamily: "'Riona Sans Light', Helvetica, Arial, sans-serif" }}
            >
              Industry-Aligned Leadership Training Programs Your Teams Can Trust
            </h2>
            <p
              className="mt-4 max-w-3xl text-[17px] leading-[1.35] text-white/75 sm:text-[19px]"
              style={{ fontFamily: "'Riona Sans Light', Helvetica, Arial, sans-serif" }}
            >
              A curated selection from Edstellar&apos;s 110+ instructor-led leadership group training programs for enterprise teams, delivered live, on-site or virtual, with measurable outcomes.
            </p>
          </div>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-5 rounded-2xl border border-eds-gray-200 bg-[#F5F3FF] px-8 py-6 sm:flex-row">
          <div>
            <h3
              ...
              style={{ fontFamily: "'Riona Sans Regular', Helvetica, Arial, sans-serif" }}
            >
              Explore the Complete Edstellar Leadership Training Catalog
            </h3>
            <p
              className="mt-1 text-[15px] text-eds-gray-500"
              style={{ fontFamily: "'Riona Sans Light', Helvetica, Arial, sans-serif" }}
            >
              Browse 110+ leadership training programs or request the latest catalog delivered to your inbox.
            </p>
          </div>
