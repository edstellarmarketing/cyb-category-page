...
import { LEADERSHIP_CASE_STUDIES } from "@/data/leadership-case-studies";
...
const CASES: CaseStudy[] = LEADERSHIP_CASE_STUDIES.map((c) => ({
  title: c.title,
...
export function LeadershipRecentCustomerSuccesses() {
