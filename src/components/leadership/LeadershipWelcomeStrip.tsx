...
const QUADRANTS: FrameworkCard[] = [
  {
    num: "5",
    title: "Capability Mastery",
    bullets: ["Executive & strategic leadership", "Change & EQ leadership"],
    question: "Build the leadership capabilities our future depends on?",
  },
  {
    num: "2",
    ...
    question: "Which training programs fit our tiers & competency model?",
  },
  {
    num: "3",
    title: "Hands-on Practice",
    bullets: ["Simulations & role-plays", "Action-learning & peer coaching"],
    question: "Where can our leaders practice real scenarios safely?",
  },
  {
    num: "4",
    title: "Assessment & ROI",
    bullets: ["Pre/post 360 assessments", "Engagement & retention KPIs"],
    question: "Measure manager effectiveness & leadership ROI?",
  },
];
...
export function LeadershipWelcomeStrip() {
  return (
    <section
      className="border-y"
    ...
    >
        ...
        <nav aria-label="Breadcrumb" className="eds-page-center py-3">
          ...
          >
            ...
            <li
              ...
              style={{ color: "#1B1D52" }}
            >
              <span itemProp="name">Leadership Training Programs</span>
      ...
      <div className="text-left">
        ...
        >
          Customized Leadership Training Programs for Enterprise Teams
        </h1>
      </div>
      ...
      <div className="mt-6 grid items-start gap-10 lg:grid-cols-12 lg:gap-14">
        <div className="text-left lg:col-span-5">
          ...
          >
            Edstellar is the leadership training company enterprises rely on to
            develop managers across every tier, from first-time supervisors to
            the executive team. Whether your people need foundational manager
            skills, senior-leader development or board readiness, every group
            training cohort is matched to vetted, certified facilitators.
          </p>
          <p
          ...
          >
            ...
            from new-manager cohorts to senior leaders preparing for their next role.
            It runs on our five-part framework that turns leadership development into
            measurable business outcomes your board reports on.
          </p>
          <ul className="space-y-3">
            <CheckBullet>
              <strong style={{ color: "#1B1D52" }}>Strategy-led design.</strong>{" "}
              Every engagement starts with a leadership capability roadmap
              aligned to your competency model.
            </CheckBullet>
            <CheckBullet>
              <strong style={{ color: "#1B1D52" }}>Global instructor-led delivery.</strong>{" "}
              Every program is delivered live by a certified facilitator. On-site,
              off-site or virtual{" "}
            ...
            <CheckBullet>
              <strong style={{ color: "#1B1D52" }}>Practice by default.</strong>{" "}
              Live simulations, role-plays, action-learning projects and
              peer-coaching circles power real-world practice.
            </CheckBullet>
            <CheckBullet>
              <strong style={{ color: "#1B1D52" }}>Measurable ROI.</strong>{" "}
              Pre/post 360 assessments, engagement and retention KPIs, and
        ...
        <div className="lg:col-span-7">
          ...
          >
            ...
            >
              ...
              >
                &ldquo;Vision for our organisation&apos;s leadership pipeline?&rdquo;
              </div>
            </div>
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <h3
            ...
            style={{ color: "#1B1D52", fontFamily: "'Riona Sans Regular', Helvetica, Arial, sans-serif" }}
          >
            Instructor-led leadership training that compounds business value.
          </h3>
          <p
            className="mx-auto mt-4 max-w-2xl text-[15px] leading-[1.5] sm:text-[16px]"
            style={{ color: "#374151", fontFamily: "'Riona Sans Light', Helvetica, Arial, sans-serif" }}
          >
            Edstellar&apos;s instructor-led leadership group training spans 110+
            programs across 11 leadership domains, designed for measurable
            engagement, retention and performance impact.
          </p>
        </div>
          ...
          {[
            {
              stat: "70%",
              caption:
                "Of the variance in team engagement traces to the manager, making manager quality the highest-leverage development investment.",
              source: "Gallup, State of the Global Workplace 2024",
            },
            {
              stat: "12%",
              caption:
                "Of organizations strongly agree they have the leadership bench strength to meet their future needs.",
              source: "DDI, Global Leadership Forecast 2023",
            },
            {
              stat: "#1",
              caption:
                "Leadership and management development is the top-ranked focus area for L&D teams worldwide.",
