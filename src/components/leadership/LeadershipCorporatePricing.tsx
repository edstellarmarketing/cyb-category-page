...
const DELIVERY_OPTIONS = [
  {
    ...
    description:
      "Our virtual group training sessions bring expert-led, high-quality leadership training to your teams anywhere, ensuring consistency and seamless integration into their schedules.",
    benefits: [
      "Train managers across multiple locations simultaneously",
  ...
  },
  {
    ...
    description:
      "Edstellar deploys a vetted facilitator to your office for immersive, hands-on leadership learning experiences. Available for any group size, anywhere.",
    benefits: [
      ...
      "Direct facilitator Q&A and hands-on practice of real leadership scenarios",
    ],
  },
];
...
const PACKAGES: Package[] = [
  {
    ...
    tagline: "Tailored for focused teams",
    licenses: "120",
    hours: "64",
  },
  {
    name: "Growth Package",
    tagline: "Ideal for scaling teams",
    licenses: "320",
    hours: "160",
    highlight: true,
  },
  ...
  {
    name: "Custom Package",
    tagline: "Built around your rollout",
    licenses: "Unlimited",
    hours: "Unlimited",
  },
];
...
const SHARED_BENEFITS: { label: string; description: string }[] = [
  {
    label: "110+ Leadership Training Programs",
    description:
      "Executive and strategic leadership, first-time manager development, change leadership, emotional intelligence and more, across every enterprise leadership domain.",
  },
  {
    label: "1,500+ Vetted Facilitators",
    description:
      "Practitioner-led delivery matched to your competency model, manager tiers, language and timezone across 100+ countries.",
  },
  {
    label: "Live simulations and role-plays included",
    description:
      "Leadership simulations, role-plays, action-learning projects and peer-coaching circles included with every cohort.",
  },
  {
    label: "On-site, virtual or hybrid delivery",
    description:
      "Live instructor-led training for leadership teams, co-located, distributed or fully remote, in any timezone.",
  },
  {
    label: "Pre and post 360 assessments",
    description:
      "Role-based capability baselining before training and manager-effectiveness measurement after, with reporting your CHRO can present to the board.",
  },
  {
    label: "Facilitator-fit trial sessions",
    description:
      "Validate leadership depth against your actual competency model before committing the cohort, trial sessions with your shortlisted facilitator.",
  },
];
...
export function LeadershipCorporatePricing() {
  return (
    <section className="bg-[#F5F3FF] py-16 md:py-20">
      <div className="eds-page-center">
        <h2
          ...
          style={{ fontFamily: "'Riona Sans Light', Helvetica, Arial, sans-serif" }}
        >
          Leadership Group Training Packages &amp; Pricing
        </h2>
        <p
          className="mt-4 max-w-3xl text-[17px] leading-[1.35] sm:text-[18px]"
          style={{ fontFamily: "'Riona Sans Light', Helvetica, Arial, sans-serif" }}
        >
          Our leadership group training is tailored to your specific development needs. Explore transparent pricing options that fit your training budget, whether you&apos;re developing a small group of managers or leaders across the entire enterprise.
        </p>
        ...
        <div className="mt-10 rounded-2xl border border-eds-gray-200 bg-white p-8 sm:p-10">
          <h3
            ...
            style={{ fontFamily: "'Riona Sans Regular', Helvetica, Arial, sans-serif" }}
          >
            Every leadership package includes
          </h3>
          <p
        ...
        <div className="mt-8 flex flex-col items-start justify-between gap-5 rounded-2xl bg-[#0c0c0c] px-8 py-7 text-white sm:flex-row sm:items-center">
          <div>
            <h3
              ...
              style={{ fontFamily: "'Riona Sans Regular', Helvetica, Arial, sans-serif" }}
            >
              Need a custom rollout, executive coaching or a blended program?
            </h3>
            <p
