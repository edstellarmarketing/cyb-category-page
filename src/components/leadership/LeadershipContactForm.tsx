...
export function LeadershipContactForm() {
      ...
      <div className="eds-page-center">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-14">
          ...
          <div className="lg:col-span-5">
            ...
            >
              Get a Quote for Your Customized Instructor-Led Leadership Training
            </h2>
            <p
              className="mt-4 max-w-md text-[17px] leading-[1.4] sm:text-[18px]"
              style={{ fontFamily: "'Riona Sans Light', Helvetica, Arial, sans-serif" }}
            >
              Tell us about your team and we&apos;ll build a customized instructor-led leadership training proposal, on-site or virtual, with a facilitator shortlist and discovery call.
            </p>
              ...
              <div className="rounded-xl border border-eds-gray-200 bg-[#F5F3FF] p-5">
                ...
                >
                  {[
                    ...
                    "Custom proposal aligned to your leadership capability roadmap",
                    "Certified facilitator shortlist with sample sessions",
                  ].map((item) => (
            ...
            >
              <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <Field
                  ...
                  label="Job Title*"
                  type="text"
                  placeholder="CHRO / VP of People / Head of L&D"
                  value={jobTitle}
