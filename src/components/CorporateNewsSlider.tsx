...
const CARDS: CorporateNewsCard[] = [
  ...
  },
  {
    ...
    title: "CEH v13, Certified Ethical Hacker (AI-powered)",
  ...
  {
    category: "AUDIT",
    title: "ISO 27001 Lead Auditor, Certify your ISMS",
    ...
    <section className="relative bg-[#F5F3FF] py-16 md:py-20">
      <div className="mtk-page-center">
        ...
        <p
          ...
          style={{ fontFamily: "'Riona Sans Light', Helvetica, Arial, sans-serif" }}
        >
          Industry-recognized certifications and instructor-led programs trusted
          by security teams worldwide.
        </p>
