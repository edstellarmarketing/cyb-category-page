...
const PROGRAMS: Program[] = [
  {
    ...
    description:
      "Kotlin-first Android with Coroutines, Flow and Jetpack Compose for production apps.",
  ...
  },
  {
    ...
    delivery: "Instructor-led (On-site/Virtual)",
    description:
      "End-to-end Android with Android Studio, Architecture Components and Play Store deployment.",
  ...
  },
  {
    ...
    delivery: "Instructor-led (On-site/Virtual)",
    description:
      "Mobile threat model, secure storage, network security, Play Integrity and OWASP MASVS aligned.",
  ...
  },
  {
    ...
    delivery: "Instructor-led (On-site/Virtual)",
    description:
      "Production Flutter for Android and iOS with state management, testing and CI workflows.",
...
export function AndroidProductNewsCards() {
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h2
              ...
              style={{ fontFamily: "'Riona Sans Light', Helvetica, Arial, sans-serif" }}
            >
              Trending Android Training Programs
            </h2>
            <p
              className="mt-4 max-w-3xl text-[17px] leading-[1.35] text-white/75 sm:text-[19px]"
              style={{ fontFamily: "'Riona Sans Light', Helvetica, Arial, sans-serif" }}
            >
              A curated selection from Edstellar&apos;s 20+ instructor-led Android and mobile group training programs for enterprise employees, delivered live, on-site or virtual, with measurable outcomes.
            </p>
          </div>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-5 rounded-2xl border border-eds-gray-200 bg-[#F5F3FF] px-8 py-6 sm:flex-row">
          <div>
            <h3
              ...
              style={{ fontFamily: "'Riona Sans Regular', Helvetica, Arial, sans-serif" }}
            >
              Explore the Complete Edstellar Android Training Catalog
            </h3>
            <p
              className="mt-1 text-[15px] text-eds-gray-500"
              style={{ fontFamily: "'Riona Sans Light', Helvetica, Arial, sans-serif" }}
            >
              Browse 20+ Android and mobile training programs or request the latest catalog delivered to your inbox.
            </p>
          </div>
