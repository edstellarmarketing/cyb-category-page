...
const QUADRANTS: FrameworkCard[] = [
  {
    ...
    bullets: ["Kotlin, Compose & Coroutines", "Gradle, CI and Play tooling"],
    question: "Keep engineers current on Kotlin, Compose & emerging Android tech?",
  },
  {
    num: "2",
    title: "Customized Instructor-Led Training",
    bullets: ["Role-based paths (Android dev, mobile QA, mobile DevOps)", "Customized programs per role"],
    question: "Which training programs fit our stack & teams?",
  },
  {
    num: "3",
    title: "Hands-On Labs",
    bullets: ["Android Studio + AVD/device farms", "Compose previews, instrumented Espresso/Appium suites"],
    question: "Where can engineers practice real workloads safely?",
  },
  {
    num: "4",
    title: "Assessment & ROI",
    bullets: ["Pre/post skill assessments", "Crash-free rate, ANR rate and build-time KPIs"],
    question: "Measure proficiency gains & app ROI?",
  },
];
...
export function AndroidWelcomeStrip() {
  return (
    <section
      className="border-y"
    ...
    >
        ...
        <nav aria-label="Breadcrumb" className="eds-page-center py-3">
          ...
          >
            ...
            <li
              ...
              style={{ color: "#1B1D52" }}
            >
              <span itemProp="name">Android Training Programs</span>
      ...
      <div className="text-left">
        ...
        >
          Customized Android & Mobile App Training Programs for Enterprise
        </h1>
      </div>
      ...
      <div className="mt-6 grid items-start gap-10 lg:grid-cols-12 lg:gap-14">
        <div className="text-left lg:col-span-5">
          ...
          >
            Edstellar is the Android training company enterprises rely on to
            build mobile capability across Kotlin, Jetpack Compose, modern
            Android tooling and cross-platform mobile stacks. Whether teams
            need entry-level skilling, role-specific upskilling or senior
          ...
          >
            ...
            from new-hire Android cohorts to senior engineers reskilling on
            Compose, Coroutines or cross-platform. It runs on our five-part
            framework that turns mobile training into app KPIs your
            engineering and product leaders report on.
          </p>
          <ul className="space-y-3">
            <CheckBullet>
              <strong style={{ color: "#1B1D52" }}>Codebase-aware design.</strong>{" "}
              Every engagement starts with a code, architecture and tooling
              audit of your real app.
            </CheckBullet>
            <CheckBullet>
              ...
              , matched to your team&apos;s location and release calendar.
            </CheckBullet>
            <CheckBullet>
              <strong style={{ color: "#1B1D52" }}>Hands-on by default.</strong>{" "}
              Android Studio, AVD farms, Compose previews and instrumented
              test labs power real-world practice.
            </CheckBullet>
            <CheckBullet>
              <strong style={{ color: "#1B1D52" }}>Measurable ROI.</strong>{" "}
              Pre/post skill assessments, crash-free rate, app size, build
              time and Play Store rating tracked.
            </CheckBullet>
          </ul>
        </div>
        ...
        <div className="lg:col-span-7">
          ...
          >
            ...
            >
              ...
              >
                &ldquo;Vision for our organisation&apos;s Android and mobile capability growth?&rdquo;
              </div>
            </div>
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <h3
            ...
            style={{ color: "#1B1D52", fontFamily: "'Riona Sans Regular', Helvetica, Arial, sans-serif" }}
          >
            Instructor-Led Android Training That Compounds App Value.
          </h3>
          <p
            className="mx-auto mt-4 max-w-2xl text-[15px] leading-[1.5] sm:text-[16px]"
            style={{ color: "#374151", fontFamily: "'Riona Sans Light', Helvetica, Arial, sans-serif" }}
          >
            Edstellar&apos;s instructor-led Android group training spans 20+
            programs across 4 mobile domains, designed for measurable
            engineering velocity and app-quality impact.
          </p>
        </div>
          ...
          {[
            {
              stat: "71%",
              caption:
                "Of the global mobile OS market runs on Android, making it the platform enterprises cannot underserve.",
              source: "Statista, Q4 2024",
            },
            {
              stat: "3B+",
              caption:
                "Active Android devices worldwide, the largest single addressable surface for enterprise mobile apps.",
