...
const stats = [
  {
    value: "20+",
    label: "Android & Mobile Programs",
    text: "Program design, not catalog picking. Built around your codebase, modularisation and release model.",
    icon: ClipboardCheck,
  },
  {
    value: "100+",
    label: "Countries",
    text: "On-site or virtual, wherever you operate, delivered in your language and to your release calendar.",
    icon: Globe2,
  },
  {
    value: "1,500+",
    label: "Vetted Trainers",
    text: "Practising mobile engineers, trial-able before you commit. Interview and run a trial session on your real app.",
    icon: UsersRound,
  },
];
...
const capabilities = [
  {
    title: "Program design, not catalog picking",
    text: "Customized Android training designed around your codebase, modularisation and tooling, not pulled from a generic catalog.",
    icon: ClipboardCheck,
  },
  {
    title: "On-site or virtual, wherever you operate",
    text: "A vetted instructor, in your office or online, aligned to your release calendar. We deliver in-region, in-language.",
    icon: GraduationCap,
  },
  {
    title: "Practising mobile engineers, trial-able",
    text: "Rigorous multi-stage vetting for every trainer. Interview and run a trial session with your shortlisted trainer before you commit.",
    icon: Medal,
  },
  {
    title: "Tailored for teams of every size",
    text: "Flexible Android training packages aligned to your goals, team structure, skill gaps, and enterprise mobile requirements.",
    icon: UsersRound,
  },
  {
...
export function AndroidWhyEdstellar() {
  return (
    <section
        ...
        <div className="grid gap-6 lg:grid-cols-[1.35fr_0.65fr]">
            <div>
              ...
              >
                ...
                <span className="text-[#6366F1]">Build Android Capability</span>
              </h2>
              <p
                className="mt-5 max-w-4xl text-[16px] leading-[1.6] text-[#374151] sm:text-[17px]"
                style={{ fontFamily: FONT_LIGHT }}
              >
                Edstellar is an Android corporate training company built for enterprise mobile engineering.
                We design every skilling, upskilling and reskilling program around your codebase, tooling and
                release model, delivered through instructor-led group training led by practising mobile
                engineers. As an Android training provider in 100+ countries, every engagement is tied to
                mobile outcomes your engineering and product leaders can act on.
              </p>
              <blockquote
              ...
              >
                ...
                trainer on your stack, and delivers a post-program report your Head of Mobile can take to
                the board: skills delta, crash-free rate gains and build-time improvements.
              </blockquote>
            </div>
            ...
            <div className="relative min-h-[260px] overflow-hidden rounded-[18px] bg-[#071735] lg:min-h-0">
              <Image
                ...
                alt="Instructor-led Android training session for enterprise teams"
                fill
          ...
          <div className="mt-5 grid gap-5 rounded-[14px] bg-[#073A93] px-6 py-6 text-white md:grid-cols-[1fr_1.15fr_1.2fr] md:items-center">
            ...
            <div className="relative min-h-[150px]">
              <Image
                ...
                alt="Countries where Edstellar has delivered Android training"
                fill
