...
import { ANDROID_CASE_STUDIES } from "@/data/android-case-studies";
...
const CASES: CaseStudy[] = ANDROID_CASE_STUDIES.map((c) => ({
  title: c.title,
...
export function AndroidRecentCustomerSuccesses() {
