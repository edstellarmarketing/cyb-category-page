...
const leftItems = [
  {
    title: "Codebase-aware design",
    text: "Every engagement starts with an audit of your real app, modules and tooling.",
    icon: Target,
  },
  {
    title: "Global instructor-led delivery",
    text: "On-site, off-site or virtual ILT/VILT, in 10+ languages, matched to your team's location and release calendar.",
    icon: Globe2,
  },
  {
    title: "Hands-on by default",
    text: "Android Studio, AVD/device farms, Compose previews and instrumented test labs power real-world practice.",
    icon: Cloud,
  },
  {
    title: "Measurable ROI",
    text: "Pre/post assessments, crash-free rate, app size and build-time KPIs tracked and reported.",
    icon: BarChart3,
  },
];
...
const cards = [
  {
    ...
    title: "5. Tech-Stack Mastery",
    icon: BrainCircuit,
    bullets: ["Kotlin, Coroutines, Jetpack Compose", "Gradle, Play and CI tooling"],
    quote: "Keeping engineers current on Kotlin, Compose & emerging Android tech?",
  },
  {
    ...
    quote: "Which training programs fit our stack & teams?",
  },
  {
    className: "right-[2px] bottom-[0px]",
    title: "3. Hands-On Labs",
    icon: Cloud,
    bullets: ["Android Studio + AVD/device farms", "Compose previews and instrumented Espresso/Appium suites"],
    quote: "Where can engineers practice real workloads safely?",
  },
  {
    ...
    quote: "Measure proficiency gains & app ROI?",
  },
];

const proofItems = [
  {
    title: "Industry-practitioner Android trainers",
    text: "Vetted, certified and experienced in real-world environments",
    icon: UsersRound,
  },
  {
  ...
  {
    title: "Actionable reports for L&D leaders and Heads of Mobile",
    text: "Transparent reporting for L&D leaders and Heads of Mobile",
    icon: FileText,
  },
  {
    title: "Measurable impact at every release",
...
export function AndroidIntroReference() {
  return (
    <section
      aria-labelledby="android-intro-reference-title"
    ...
    >
      ...
      <div className="eds-page-center relative">
        ...
        >
          ...
          <span aria-hidden="true">&gt;</span>
          <span className="text-[#1B1D52]">Android Training Programs</span>
        </nav>

        <div className="grid gap-12 lg:grid-cols-[1fr_1fr] lg:min-h-[680px]">
          <div>
            <h2
              id="android-intro-reference-title"
              className="max-w-[610px] text-[36px] leading-[1.08] text-[#1B1D52] sm:text-[42px] lg:text-[48px]"
              style={{ fontFamily: FONT_LIGHT }}
            >
              How Edstellar Builds Android Capability Inside Your Enterprise
            </h2>
            ...
            <p
              ...
              style={{ fontFamily: FONT_LIGHT }}
            >
              Edstellar designs Android capability around your app, your modularisation and your
              release calendar. Every customized, instructor-led program turns a training engagement
              into measurable outcomes your Head of Mobile and product leaders can rely on, not a
              generic Android syllabus handed to anyone with a laptop.
            </p>
            ...
            <div className="absolute left-[258px] top-[204px] z-20 flex h-[276px] w-[276px] items-center justify-center rounded-full border-[7px] border-[#6366F1] bg-white text-center shadow-[0_15px_38px_rgba(44,47,145,0.15)]">
              ...
              <div>
                ...
                <p className="mx-auto mt-5 max-w-[150px] text-[14px] italic leading-[1.45] text-[#697084]" style={{ fontFamily: FONT_REGULAR }}>
                  &ldquo;Vision for our organization&apos;s Android and mobile capability growth?&rdquo;
                </p>
              </div>
            </div>
