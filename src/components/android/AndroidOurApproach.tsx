...
const STEPS: Step[] = [
  {
    ...
    title: "Discover",
    description:
      "We meet with your Head of Mobile and L&D team to audit the current Android codebase, tooling and team profile against role-based benchmarks. Output: a prioritised skill-gap report tied to app KPIs.",
  },
  {
    num: "02",
    title: "Design",
    description:
      "We build a customized curriculum mapped to your stack (Kotlin/Compose, modularisation, CI), then shortlist certified Android trainers from our 1,500+ network for trial sessions on representative slices of your real app.",
  },
  {
    num: "03",
    title: "Deliver",
    description:
      "Instructor-led sessions, virtual, on-site or hybrid, in your language, with hands-on labs in Android Studio, AVD and physical device farms, Compose previews and instrumented Espresso and Appium suites.",
  },
  {
    num: "04",
    title: "Assess",
    description:
      "Pre and post technical assessments, code-quality benchmarks, lab benchmarks and live app KPIs like crash-free rate, ANR rate and build time. Every cohort closes with a measurable delta.",
  },
  {
    num: "05",
    title: "Optimise",
    description:
      "Quarterly retrospectives, refresher modules tied to each new Android version, skill-refresh tracking and a dedicated Learning Services Manager driving long-term mobile ROI.",
  },
];

export function AndroidOurApproach() {
  return (
      ...
      <div className="eds-page-center">
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div className="max-w-3xl">
            ...
            >
              Edstellar Approach to Enterprise Android Training
            </h2>
            <p
            ...
            >
              ...
              methodology that turns Android and mobile training into measurable
