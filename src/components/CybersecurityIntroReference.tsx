...
const leftItems = [
  {
    ...
    text: "Every engagement starts with a capability roadmap aligned to your security goals.",
    icon: Target,
  },
  {
  ...
  },
  {
    ...
    text: "Cloud sandboxes, MITRE ATT&CK and CTF labs power real-world practice.",
    icon: Cloud,
  },
  {
    title: "Measurable ROI",
    text: "Pre/post skill assessments, training outcomes and security KPIs tracked and reported.",
    icon: BarChart3,
  },
];
...
const cards = [
  {
    ...
    quote: "Keeping engineers current on AI, cloud & emerging cyber tech?",
  },
  {
  ...
  },
  {
    ...
    quote: "Measure proficiency gains & security ROI?",
  },
];
...
const proofItems = [
  ...
  {
    title: "Actionable reports & insights",
    text: "Transparent reporting for L&D leaders and CISOs",
    icon: FileText,
  },
  {
...
export function CybersecurityIntroReference() {
  return (
    <section
      aria-labelledby="cyber-intro-reference-title"
    ...
    >
      ...
      <div className="eds-page-center relative">
        ...
        >
          ...
          <span aria-hidden="true">&gt;</span>
          <span className="text-[#1B1D52]">Cybersecurity Training Programs</span>
        </nav>

        <div className="grid gap-12 lg:grid-cols-[1fr_1fr] lg:min-h-[680px]">
          <div>
            <h2
              id="cyber-intro-reference-title"
            ...
            <p
              ...
              style={{ fontFamily: FONT_LIGHT }}
            >
              Edstellar helps enterprises build cybersecurity capability that&apos;s tailored to their threat
              landscape, roles, tools and compliance needs. Our customized instructor-led programs turn every
              training engagement into measurable outcomes your board and security leaders can rely on.
            </p>
          ...
          <div className="relative hidden min-h-[682px] lg:block">
            <div className="absolute left-[258px] top-[204px] z-20 flex h-[276px] w-[276px] items-center justify-center rounded-full border-[7px] border-[#6366F1] bg-white text-center shadow-[0_15px_38px_rgba(44,47,145,0.15)]">
              ...
              <div>
                <ShieldCheck className="mx-auto mb-7 h-[62px] w-[62px] text-[#6366F1]" strokeWidth={2} aria-hidden="true" />
                ...
                <p className="mx-auto mt-5 max-w-[150px] text-[14px] italic leading-[1.45] text-[#697084]" style={{ fontFamily: FONT_REGULAR }}>
                  &ldquo;Vision for our organization&apos;s cyber capability growth?&rdquo;
                </p>
              </div>
            </div>
