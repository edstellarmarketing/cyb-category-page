...
const stats = [
  {
    ...
    text: "Designed around your threat model, roles, stack, and compliance needs.",
    icon: ClipboardCheck,
  },
  {
    value: "100+",
    label: "Countries",
    text: "On-site or virtual delivery in your language, wherever you operate.",
    icon: Globe2,
  },
  {
    value: "1,500+",
    label: "Vetted Cybersecurity Trainers",
    text: "Industry-practitioner trainers vetted for technical depth and delivery excellence.",
    icon: UsersRound,
  },
];
...
const capabilities = [
  {
    ...
    text: "Customized training designed around your threat model, stack, and roles, not pulled from a generic catalog.",
    icon: ClipboardCheck,
  },
  {
    title: "On-site or virtual, wherever you operate",
    text: "A vetted instructor, in your office or online, aligned to your local compliance framework. We deliver in-region, in-language.",
    icon: GraduationCap,
  },
  {
  ...
  },
  {
    ...
    text: "Flexible training packages aligned to your goals, team structure, skill gaps, and enterprise learning requirements.",
    icon: UsersRound,
  },
  {
  ...
  },
  {
    ...
    text: "Dedicated Training Solutions Manager to handle planning, delivery, communication, and post-training support end-to-end.",
    icon: MapPinned,
  },
];

const deliveryStats = [
  { label: "Scalable Global Delivery", icon: Globe2 },
  { label: "10+ Popular Languages", icon: Languages },
  { label: "Local compliance Alignment", icon: ShieldCheck },
  { label: "On-Site & Virtual", icon: MapPinned },
];
...
export function WhyEdstellarV2() {
  return (
    <section
        ...
        <div className="grid gap-6 lg:grid-cols-[1.35fr_0.65fr]">
            <div>
              ...
              >
                ...
                <span className="text-[#6366F1]">Build Cybersecurity Capability</span>
              </h2>
              <p
                className="mt-5 max-w-4xl text-[16px] leading-[1.6] text-[#374151] sm:text-[17px]"
                style={{ fontFamily: FONT_LIGHT }}
              >
                Edstellar is a dedicated cybersecurity corporate training company built for enterprise
                workforce development. Unlike course marketplaces, Edstellar designs every upskilling and
                reskilling program around your threat model and delivers it through instructor-led group
                training led by industry practitioners, always tied to measurable outcomes your CISO and
                board can act on.
              </p>
            </div>
            ...
            <div className="relative min-h-[260px] overflow-hidden rounded-[18px] bg-[#071735] lg:min-h-0">
              <Image
                ...
                alt="Instructor-led cybersecurity training session for enterprise teams"
                fill
