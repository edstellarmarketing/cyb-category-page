  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        notes:
          "Open with 'Edstellar is the [category] training company enterprises rely on' — this is the primary commercial-intent keyword anchor for the section. Must include all three: skilling, upskilling, reskilling — in that order. Must mention 'group training cohort'. Use 'certified trainers' (not vendor-certified).",
        example:
          "Edstellar is the cybersecurity training company enterprises rely on to build deep capability across CISSP, CEH v13, CCSP, CISM, OSCP and emerging AI-security disciplines. Whether your security teams need entry-level skilling, role-specific upskilling, or senior-level reskilling, every group training cohort is matched to vetted, certified trainers with hands-on enterprise practice.",
      },
      {
        element: "Paragraph 2",
        charLimit: "235–295",
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        charLimit: "260–360",
        keywords: [
          "[category] corporate training company",
        ...
        notes:
          "Open with 'Edstellar is a dedicated [category] corporate training company built for enterprise workforce development' — this plants the primary commercial-intent variant. End with 'As a [category] training provider operating in 100+ countries' to capture the provider variant. Must cover all three: skilling, upskilling, reskilling. Must include '[category] workforce development' as a phrase. Must mention instructor-led group training and industry practitioners.",
        example:
