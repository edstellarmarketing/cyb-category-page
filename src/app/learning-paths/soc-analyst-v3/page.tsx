...
import { CustomTrackBuilder } from "@/components/custom-track/CustomTrackBuilder";
import { CustomTrackContactForm } from "@/components/custom-track/CustomTrackContactForm";
import { CustomTrackTriggerButton } from "@/components/custom-track/CustomTrackTriggerButton";

export const metadata: Metadata = {
  title:
    "SOC Analyst Learning Path with a Custom Track Builder | Edstellar",
  description:
    "Build a custom SOC analyst learning track in 60 seconds — Edstellar's curriculum architect method composes a track from core SOC skills plus connected skills like leadership, comms, and cloud SOC, shaped to your stack, sector, and team gaps.",
  openGraph: {
    title:
      "Build a custom SOC analyst learning track in 60 seconds — Edstellar",
    description:
      "Answer 7 questions and an Edstellar curriculum architect's method composes a custom SOC track on the spot, drawing from core SOC skills and connected skills the survey signals you need.",
  },
  alternates: {
    canonical: "https://edstellar.com/learning-paths/soc-analyst-v3",
  },
};
...
export default function SocAnalystLearningPathV3Page() {
  return (
    <>
      <Header />
      <CustomTrackBuilder />
        ...
        <section id="stages" className="bg-white py-16 md:py-20">
          <div className="eds-page-center">
            <div className="max-w-3xl">
              ...
              >
                The Edstellar standard 5-stage SOC analyst track
              </h2>
              <p
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
              ...
              <CustomTrackTriggerButton variant="outline" label="Build a custom track" />
            </div>
          </div>
        </section>
