...
export const metadata: Metadata = {
  ...
  description:
    "Edstellar's SOC Analyst Learning Path standardises blue-team capability across enterprise security teams with a 5-stage curriculum, mentor-led training, and measurable risk-reduction outcomes.",
};
            ...
            <div className="grid items-center gap-10 lg:grid-cols-12 lg:gap-14">
              <div className="lg:col-span-7">
                ...
                >
                  ...
                  and SOAR labs, training milestones and measurable
          ...
          <div className="eds-page-center">
            <div className="max-w-3xl">
              ...
              >
                ...
                hands-on labs and training milestones at every stage.
              </p>
            </div>
