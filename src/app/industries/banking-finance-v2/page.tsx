...
const SCALE_PILLARS: ScalePillar[] = [
  ...
  },
  {
    ...
    body: "Every cohort learns from certified BFSI practitioners, calibrated to the same role-based competency standards.",
  },
  {
  ...
  {
    title: "10 languages",
    body: "Programs delivered in English, EspaÃ±ol, æ™®é€šè©±, Deutsch, Ø§Ù„Ø¹Ø±Ø¨ÙŠØ©, PortuguÃªs, à¤¹à¤¿à¤‚à¤¦à¥€, FranÃ§ais, æ—¥æœ¬èªž, and Italiano.",
  },
  {
...
const CASE_STUDIES_MINI: CaseStudyMini[] = [
  ...
  },
  {
    ...
    outcome: "350+ ops analysts trained on a single role-based AML / KYC curriculum, audit-ready in 9 weeks.",
  },
];
  ...
  return (
    <>
      ...
      <main className="flex-1">
        {/* Section 1 â€” Full-bleed hero slide */}
        <section
        ...
        {/* Section 2 â€” Different Approach */}
        <section
          id="approach"
        ...
        {/* Section 6 â€” Training Delivery at Scale */}
        <section
          className="py-16 md:py-20"
          style={{ backgroundColor: "#F7F8FC" }}
        >
        ...
        {/* Section 7 â€” From Fragmented Skills to High-Performing BFSI Workforces */}
        <BankingFinanceCapabilityPath />

        {/* Section 8 â€” Proven results: featured case + key outcomes + mini cards */}
        <section
          className="py-16 md:py-20"
          style={{ backgroundColor: "#F7F8FC" }}
        >
