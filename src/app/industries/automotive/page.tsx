...
const SEGMENTS: Segment[] = [
  ...
  },
  {
    ...
    body: "Programs aligned to OEM customer obligations, ASPICE, and supplier-mandated compliance requirements.",
  },
  {
...
const PROGRAM_STATS = [
  { stat: "âˆ’32%", label: "Engineering cycle-time reduction (indicative range)" },
  { stat: "âˆ’27%", label: "Software defect-density reduction (indicative range)" },
  { stat: "94%", label: "Post-training skill improvement rate (indicative)" },
  ...
  return (
    <>
      ...
      <main className="flex-1">
                  ...
                  <div className="flex items-start gap-2.5">
                    ...
                    <div>
                      ...
                      >
                        ...
                        Tier 1 capability disclosures, 2023â€“2025. Verify with
            ...
            <div className="grid items-start gap-10 lg:grid-cols-12 lg:gap-14">
              <div className="lg:col-span-7">
                ...
                <ul className="mt-8 space-y-6">
                  ...
                  />
                  <CheckBullet
                    title="certified training delivery"
                  ...
                  <CheckBullet
                    ...
                    body="Pre and post assessments, skill mastery tracking, and engineering KPIs (lead time, defect density, cycle time) packaged in a board-ready dashboard."
                  />
                </ul>
              </div>
              <div className="lg:col-span-5">
        ...
        {/* Section 4 â€” What we do (tabs) */}
        <IndustryAutomotiveTabs />

        {/* Section 5 â€” Our success stories */}
        <section
          className="py-16 md:py-20"
          style={{ backgroundColor: "#F7F8FC" }}
        >
        ...
        {/* Section 7 â€” Outcomes and impact */}
        <section
          className="py-16 md:py-20"
          style={{ backgroundColor: "#F7F8FC" }}
        >
            ...
            <div className="grid items-center gap-10 lg:grid-cols-12 lg:gap-16">
              <div className="lg:col-span-7">
                ...
                >
                  ...
                  engagements 2023â€“2025. Verify with your Edstellar advisor
                  before citing.
                </p>
              </div>
              <div className="lg:col-span-5">
