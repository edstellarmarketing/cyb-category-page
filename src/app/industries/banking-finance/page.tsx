...
export default function IndustryBankingFinancePage() {
  return (
    <>
      <Header />
          ...
          <div className="eds-page-center">
            ...
            <div className="grid items-center gap-10 lg:grid-cols-12 lg:gap-14">
              <div className="lg:col-span-7">
                <h1
                  className="text-[34px] leading-[1.05] sm:text-[42px] lg:text-[52px]"
                  style={{
                    color: NAVY,
                    fontFamily:
                      "'Riona Sans Light', Helvetica, Arial, sans-serif",
                ...
                <p
                  className="mt-5 max-w-2xl text-[14.5px] leading-[1.55] sm:text-[15.5px]"
                  style={{
                    color: BODY,
                    fontFamily:
                      "'Riona Sans Light', Helvetica, Arial, sans-serif",
                ...
                <div className="mt-5">
                  ...
                  <div className="mt-2.5 flex flex-wrap items-center gap-x-5 gap-y-2 text-[13px] sm:text-[13.5px]">
                    <div className="group relative inline-flex items-center gap-1.5">
                      ...
                      <button
                        type="button"
                        aria-describedby="bfsi-languages-tooltip"
              ...
              <div className="lg:col-span-5">
                ...
                >
                  <Image
                    src="/images/cyber/hero-bfsi-pros.jpg"
                    alt="BFSI advisor reviewing tax, compliance, and capital-gains documents alongside a calculator inside an Edstellar-supported finance program"
                    fill
